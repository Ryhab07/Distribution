      ...
      <div className="lg:pt-10 p-10 max-w-[1280px] mx-auto   mt-10  mb-10">
        ...
        {userData.map((user) => (
          <div
            key={user._id}
            //ref={pdfRef}
            className="border border-gray-300 mt-10 rounded-md p-10"
          >
            <div className="border-b border-gray-200 w-full pb-4 flex flex-wrap">
              ...
              <div className="flex flex-col pl-6 pr-2">
                {user.picture1.map((picture, index) => {
                  ...
                  const documentName = `Pièce jointe ${index + 1}`;
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2 text-left">
              <div className="font-bold border-r-2 border-gray-200 pl-2 w-1/2 pb-6">
                INSTALLATEUR:{" "}
              </div>
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6">
                {user.installateur}
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 ">
                CLIENT:{" "}
              </div>
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              ...
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 ">{user.causeSAV}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 ">
                MARQUE:{" "}
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              ...
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 ">{user.modele}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 ">
                CATEGORIE ARTICLE :{" "}
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              ...
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 ">{user.accord}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 ">
                DATE RETOUR DEPOT :{" "}
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-2">
              ...
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 ">{user.prixAchat}</div>
            </div>
            <div className="flex justify-start mt-1 items-center  p-2">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 ">
                PRIX DE VENTE :{" "}
              </div>
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 ">{user.prixVente}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-t-[#d1d5db] border-t p-4">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 ">
                Statut:{" "}
              </div>
        ...
        <div
          className={`mt-4 border p-4 rounded-md bg-white ${
            showDiv ? "" : "hidden"
          }`}
          ref={pdfRef}
        >
          <SavPDFPage data={userData[0]} type="Machine" />
        </div>
      </div>
    </div>
  );
