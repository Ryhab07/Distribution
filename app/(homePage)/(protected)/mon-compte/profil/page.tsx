  ...
  return (
    <div className="flex-col justify-between lg:pt-[70px] pt-[60px]">
      ...
      <div className="p-10 max-w-[1280px] mx-auto">
        <div className=" mt-10  border border-[#B2EAFC] p-4 gap-6  rounded-[20px]">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-8">
          <div className="grid gap-1">
              <div className="grid gap-1">
                <Label className="text-xl font-bold text-larnaBlue">Nom d’entreprise </Label>
                <div className="w-[100%] h-[40px] rounded-md border border-[#B2EAFC] bg-white p-4 flex items-center ">
            ...
            <div className="grid gap-1">
              <div className="grid gap-1">
                <Label className="text-xl font-bold text-larnaBlue">Contact</Label>
                <div className="w-[100%] h-[40px] rounded-md border border-[#B2EAFC] bg-white p-4 flex items-center ">
            ...
            <div className="grid gap-1">
              <div className="grid gap-1">
                <Label className="text-xl font-bold text-larnaBlue">Email </Label>
                <div className="w-[100%] h-[40px] rounded-md border border-[#B2EAFC] bg-white p-4 flex items-center ">
            ...
            <div className="grid gap-1">
              <div className="grid gap-1">
                <Label className="text-xl font-bold text-larnaBlue">Email secondaire </Label>
                <div className="w-[100%] h-[40px] rounded-md border border-[#B2EAFC] bg-white p-4 flex items-center ">
            ...
            <div className="grid gap-1">
              <div className="grid gap-1">
                <Label className="text-xl font-bold text-larnaBlue">
                  Numéro de téléphone
                </Label>
                <div className="w-[100%] h-[40px] rounded-md border border-[#B2EAFC] bg-white p-4 flex items-center ">
            ...
            <div className="grid gap-1">
              <div className="grid gap-1">
                <Label className="text-xl font-bold text-larnaBlue">Mot de passe </Label>
                <div className="w-[100%] h-[40px] rounded-md border border-[#B2EAFC] bg-white p-4 flex items-center ">
