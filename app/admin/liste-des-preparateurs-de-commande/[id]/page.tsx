...
const Page = () => {
  ...
  return (
    <div className="min-h-screen flex-col justify-between lg:pt-[70px] pt-[60px] ">
      <BannerTitle tile={"DETAIL DE PREPARATEUR DE COMMANDE"} paragraph={""} />
      <Breadcrumb
        paths={[
          { name: "Accueil", url: "/admin/mon-compte" },
          { name: "Mon compte", url: "/admin/mon-compte" },
          {
            name: "Liste des Preparateur de commande",
            url: "/admin/liste-des-preparateurs-de-commande",
          },
          { name: "Detail de Preparateur de commande", url: "#" },
        ]}
      />
