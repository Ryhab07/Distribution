...
const Page = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const filteredUsers = data.users.filter((user) => user.role === "collaborator");
  ...
  return (
    <div className="min-h-screen flex-col justify-between lg:pt-[70px] pt-[60px]">
      <BannerTitle tile={"Liste des collaborateurs"} paragraph={""} />
      <Breadcrumb
        paths={[
          { name: "Accueil", url: "/admin/mon-compte" },
          { name: "Mon compte", url: "/admin/mon-compte" },
          { name: "Liste des collaborateurs", url: "#" },
        ]}
      />
      <div className="lg:pt-20 p-10 max-w-[1280px] mx-auto">
        ...
        <div className="flex justify-end">
          <AddButton
            ...
            destination="/admin/nouveau-collaborateur"
          />
        </div>
