...
const Page = () => {
  ...
  return (
    <div className="min-h-screen flex-col justify-between lg:pt-[70px] pt-[60px] ">
      <BannerTitle tile={"DETAIL DE COLLABORATEUR"} paragraph={""} />
      <Breadcrumb
        paths={[
          ...
          { name: "Mon compte", url: "/admin/mon-compte" },
          {
            ...
            url: "/admin/liste-des-collaborateur",
          },
          { name: "Detail de Collaborateur", url: "#" },
        ]}
      />
      <div className="lg:pt-10 p-10 max-w-[1280px] mx-auto  mt-10 rounded-md mb-10">
        <div className="flex justify-between gap-4 lg:flex-row flex-col">
          <div className="flex justify-end lg:flex-row flex-col mb-10 gap-4">
            ...
            <InfoModifierWorker id={id} role={role} />
            {/*<SalesModifier
        ...
        {userData.map((user, index) => (
          <div key={index} className="border border-gray-300 p-6 rounded-md">
            <div className="flex justify-start lg:flex-row flex-col mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold lg:border-r lg:border-gray-200 lg:pl-2 lg:lg:w-1/2 w-full pb-6 ">
                SOCIETE:{" "}
              </div>
            ...
            <div className="flex justify-start lg:flex-row flex-col mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold lg:border-r lg:border-gray-200 lg:pl-2 lg:lg:w-1/2 w-full pb-6 uppercase ">
                Client:{" "}
              </div>
              <div className="py-2 lg:pl-8 pr-2 lg:w-1/2 w-full pb-6 ">
