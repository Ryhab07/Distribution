...
const Page = () => {
  ...
  return (
    <div className="min-h-screen flex-col justify-between lg:pt-[70px] pt-[60px] ">
      <BannerTitle tile={"DETAIL DE CLIENT"} paragraph={""} />
      <Breadcrumb
        paths={[
          { name: "Accueil", url: "/admin/mon-compte" },
          { name: "Mon compte", url: "/admin/mon-compte" },
          { name: "Liste des clients", url: "/admin/liste-des-clients" },
      ...
      <div className="flex justify-end lg:flex-row flex-col mb-10 gap-4">
            ...
            <SalesModifier
              ...
              role={role}
            />
            <Button className="bg-red-500" onClick={() => setShowDeleteModal(true)}>
