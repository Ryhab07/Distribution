...
const Page = () => {
  ...
  useEffect(() => {
    fetchUserData();
  }, [installateur, marque, serieNumber, category, selectedDate, selectedDateDemande, societe]);
  ...
  const handleCardSelect = (id: string) => {
    setSelectedId(id);
    window.location.href = `/collaborateur/sav/sav-intervention-detail?search=${id}`;
  };
      ...
      <div className="lg:pt-20 p-10 max-w-[1280px] mx-auto">
        <div className="flex lg:flex-row flex-col justify-end lg:gap-10 gap-4">
          <AddButton
            ...
            destination="/collaborateur/sav/sav-intervention"
          />
          <Button
