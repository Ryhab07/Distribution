      ...
      <Breadcrumb
        paths={[
          ...
          { name: "sav", url: "/collaborateur/sav" },
          {
            ...
            url: "/collaborateur/sav/liste-intervention",
          },
          {
        ...
        {userData.map((user) => (
          <div key={user._id} className="border border-gray-300 p-6 rounded-md">
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 break-words ">
                SOCIETE:{" "}
              </div>
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 break-words">{user.societe}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 break-words ">
                CLIENT:{" "}
              </div>
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 break-words ">{user.client}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 break-words">
                MARQUE:{" "}
              </div>
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 break-words">{user.marque}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 break-words ">
                NUMERO DE SERIE:{" "}
              </div>
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 break-words ">
                {user.serieNumber}
              </div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              ...
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 break-words">{user.nDeTicket}</div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 break-words">
                DEVIS Econegoce:{" "}
            ...
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              ...
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 break-words">
                {user.factureFournisseur &&
                user.factureFournisseur.length > 0 ? (
                  <ul>
                    {user.factureFournisseur.map((facture, index) => (
                      <li key={index}>{facture}</li>
                    ))}
                  </ul>
                ) : (
                  <span>-</span> // Show dash if no facture found
                )}
              </div>
            </div>
            <div className="flex justify-start mt-1 items-center border-b-[#d1d5db] border-b p-4">
              <div className="font-bold border-r border-gray-200 pl-2 w-1/2 pb-6 break-words">
                BON DE COMMANDE LARNA:{" "}
              </div>
              <div className="py-2 pl-8 pr-2 w-1/2 pb-6 break-words">
