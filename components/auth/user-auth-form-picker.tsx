...
export function UserAuthFormPicker({ className, ...props }: UserAuthFormProps) {
      ...
      fetch(`${process.env.NEXT_PUBLIC_API_URL}/auth/signup`, {
        ...
        .then((data) => {
          if (data.success) {
            ...
            setPending(false);
            window.location.href = "/admin/liste-des-preparateurs-de-commande";
          } else {
            setError(data.error);
            setPending(false);
          }
                        ...
                        <div className="flex lg:justify-end items-end gap-4">
                          ...
                          <div className="col-start-2">
                            <Button
                              ...
                              onClick={() => {
                                window.location.href = "/admin/liste-des-preparateurs-de-commande"; // Replace with your desired URL
                              }}
                            >
                              <span
