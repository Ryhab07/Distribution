...
export function PDFHeader({ confirmation, date }) {
  ...
  return (
    <div className="w-full mb-10  h-[300px]">
      <div className=" ">
        <div
          className="pt-0 pl-5 flex justify-between w-full "
        ...
        <div           className="pt-20 pl-5 flex justify-between bg-contain bg-right-bottom w-full relative bg-image h-[80px]"
      ...
      <div>
        <div className=" pl-5 pr-5 flex justify-between ">
          ...
          <div className="bg-[#fab516] p-4 rounded !w-[300px] items-center my-auto">
            <div className="flex justify-between text-[12px] font-bold">
              <p className="text-[16px]">Numéro du Bon</p>
              <p className="text-[16px]">{confirmation} </p>
            </div>
            <div className="flex justify-between">
              <p className="text-[12px] font-bold">Date démission </p>
              <p className="text-[10px]">{formattedDate} </p>
            </div>
            <div className="flex justify-between mt-2">
              <p className="text-[11px] w-[30%] font-bold">A retirer à : </p>
              <p className="text-[10px] w-[70%] ">
                Tremblay WMS - 53 AV DU BOIS DE LA PIE 93290 TREMBLAY EN FRANCE
              </p>
            </div>
          </div>
        </div>
