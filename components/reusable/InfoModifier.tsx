...
export function InfoModifier(id, type) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[1000px] max-h-[calc(100vh-4rem)] overflow-y-auto lg:w-full w-[90%] mx-auto">
        ...
        <DialogHeader>
          <DialogTitle>Modifier Les Information des clients</DialogTitle>
          <DialogDescription>
            Personnalisez les informations pour chaque client selon leurs
